...
| Changelogs | `README.md` | Record feature changes in the README changelog and the matching adapter release news |
...
- add the corresponding English release note to `README.MD` when preparing the release.
